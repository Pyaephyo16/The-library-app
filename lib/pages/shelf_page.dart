    ...
    return Row(
      children: [
          IconButton(
           ...
           icon: Icon(Icons.chevron_left_outlined,size: MARGIN_MEDIUM_4,color: Colors.blue,),
           ),
           Spacer(),
           IconButton(
            onPressed: (){
           ...
           icon: Icon(Icons.search,size: MARGIN_MEDIUM_4,color: Colors.blue,),
           ),
           DropdownButton(
     alignment: Alignment.center,
    hint: FaIcon(FontAwesomeIcons.ellipsisVertical),iconSize: MARGIN_SIZE_FOR_ICON,
     underline: SizedBox(),
     icon: SizedBox(),
      items: [
        DropdownMenuItem(child: Text(RENAME_SHELF_TEXT),value: 0,),
        DropdownMenuItem(child: Text(DELETE_SHELF_TEXT),value: 1,)
      ],
       onChanged: (int? index){
          renameOrDelShelf(index);
          if(index == 1){
