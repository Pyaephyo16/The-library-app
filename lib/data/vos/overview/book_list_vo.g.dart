...
class BookListVOAdapter extends TypeAdapter<BookListVO> {
  ...
  BookListVO read(BinaryReader reader) {
    ...
    return BookListVO(
      ...
      listImageWidth: fields[6] as double?,
      listImageHeight: fields[7] as double?,
...
BookListVO _$BookListVOFromJson(Map<String, dynamic> json) => BookListVO(
      ...
      listImageWidth: (json['list_image_width'] as num?)?.toDouble(),
      listImageHeight: (json['list_image_height'] as num?)?.toDouble(),
